        ...
        where TRequest : notnull
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    _logger.LogError(ex, "AndersonAPI Request: Unhandled Exception for Request {Name} {@Request}", requestName, request);
                }
                else
                {
                    _logger.LogError(ex, "AndersonAPI Request: Unhandled Exception for Request {Name}", requestName);
                }
                throw;
            }
        }
