...
namespace AndersonAPI.Application.Oppertunities.UpdateMessageOppertunity
{
    ...
    public class UpdateMessageOppertunityCommandHandler : IRequestHandler<UpdateMessageOppertunityCommand>
    {
        private readonly IOppertunityRepository _oppertunityRepository;

        [IntentManaged(Mode.Merge)]
        public UpdateMessageOppertunityCommandHandler(IOppertunityRepository oppertunityRepository)
        {
            _oppertunityRepository = oppertunityRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task Handle(UpdateMessageOppertunityCommand request, CancellationToken cancellationToken)
        {
            ...
            oppertunity.UpdateMessage(request.MessageId, request.Content);
        }
    }
}