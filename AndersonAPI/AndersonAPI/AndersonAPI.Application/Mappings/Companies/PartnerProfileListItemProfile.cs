    ...
    public class PartnerProfileListItemProfile : Profile
    {
        public PartnerProfileListItemProfile()
        {
            CreateMap<Company, PartnerProfileListItem>()
                ...
                .ForMember(d => d.Locations, opt => opt.MapFrom(src => src.Locations.Where(l => l.IsHeadOffice == false)))
                .ForMember(d => d.HeadOffice, opt => opt.MapFrom(src => src.Locations.Where(l => l.IsHeadOffice)))
