...
export const putApiCompaniesConnectionRequest = <ThrowOnError extends boolean = false>(options: Options<PutApiCompaniesConnectionRequestData, ThrowOnError>) => (options.client ?? client).put<PutApiCompaniesConnectionRequestResponses, PutApiCompaniesConnectionRequestErrors, ThrowOnError>({
...
export const getApiCompaniesByIdContacts = <ThrowOnError extends boolean = false>(options: Options<GetApiCompaniesByIdContactsData, ThrowOnError>) => (options.client ?? client).get<GetApiCompaniesByIdContactsResponses, GetApiCompaniesByIdContactsErrors, ThrowOnError>({ url: '/api/companies/{id}/contacts', ...options });
...
export const putApiOpportunitiesByIdAddInterestedPartners = <ThrowOnError extends boolean = false>(options: Options<PutApiOpportunitiesByIdAddInterestedPartnersData, ThrowOnError>) => (options.client ?? client).put<PutApiOpportunitiesByIdAddInterestedPartnersResponses, PutApiOpportunitiesByIdAddInterestedPartnersErrors, ThrowOnError>({
...
export const putApiOpportunitiesByIdRemoveInterestedPartners = <ThrowOnError extends boolean = false>(options: Options<PutApiOpportunitiesByIdRemoveInterestedPartnersData, ThrowOnError>) => (options.client ?? client).put<PutApiOpportunitiesByIdRemoveInterestedPartnersResponses, PutApiOpportunitiesByIdRemoveInterestedPartnersErrors, ThrowOnError>({
...
export const getApiReviews = <ThrowOnError extends boolean = false>(options?: Options<GetApiReviewsData, ThrowOnError>) => (options?.client ?? client).get<GetApiReviewsResponses, GetApiReviewsErrors, ThrowOnError>({
...
export const getApiReviewsById = <ThrowOnError extends boolean = false>(options: Options<GetApiReviewsByIdData, ThrowOnError>) => (options.client ?? client).get<GetApiReviewsByIdResponses, GetApiReviewsByIdErrors, ThrowOnError>({
...
export const getApiReviewsCompanyById = <ThrowOnError extends boolean = false>(options: Options<GetApiReviewsCompanyByIdData, ThrowOnError>) => (options.client ?? client).get<GetApiReviewsCompanyByIdResponses, GetApiReviewsCompanyByIdErrors, ThrowOnError>({
