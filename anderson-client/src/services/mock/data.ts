...
export const MOCK_PARTNERS: Partner[] = [
  {
    ...
    description: 'Leading data analytics and business intelligence firm specializing in Qlik and Snowflake implementations.',
    ...
    contacts: [
      { name: 'Sarah Johnson', email: 's.johnson@insight.example.com', isDefault: true },
      { name: 'David Smith', email: 'd.smith@insight.example.com', isDefault: false }
    ],
    users: [
      { email: 's.johnson@insight.example.com', firstName: 'Sarah', lastName: 'Johnson', title: 'Managing Partner' },
      { email: 'm.bekker@insight.example.com', firstName: 'Mark', lastName: 'Bekker', title: 'Senior Data Architect' }
    ],
    reviews: [
      { rating: 5, comment: 'Exceptional delivery on our Snowflake migration.', reviewerName: 'Global Retail Corp', date: '2023-11-12' },
      { rating: 4, comment: 'Strong technical skills, very responsive.', reviewerName: 'Standard Bank', date: '2024-01-05' }
    ]
  },
  {
    id: '2',
    ...
    description: 'Specialists in cloud infrastructure migration and sustainable IT solutions.',
    ...
    contacts: [
      { name: 'Lars Jensen', email: 'l.jensen@nordictech.example.com', isDefault: true }
    ],
    users: [
      { email: 'l.jensen@nordictech.example.com', firstName: 'Lars', lastName: 'Jensen', title: 'CEO' },
      { email: 'e.nilsson@nordictech.example.com', firstName: 'Erik', lastName: 'Nilsson', title: 'Cloud Lead' }
    ],
    reviews: [
      { rating: 5, comment: 'Highly recommended for AWS migrations.', reviewerName: 'Vattenfall', date: '2023-09-20' }
    ]
  },
  {
    id: '3',
    ...
    description: 'Digital transformation experts focused on banking modernization and blockchain.',
    ...
    contacts: [
      { name: 'Maria Silva', email: 'm.silva@latamfin.example.com', isDefault: true }
    ],
    users: [
      { email: 'm.silva@latamfin.example.com', firstName: 'Maria', lastName: 'Silva', title: 'Director of Innovation' }
    ],
    reviews: [
      { rating: 5, comment: 'Transformed our core banking system in record time.', reviewerName: 'Itau Unibanco', date: '2023-12-01' }
    ]
  },
  {
    id: '4',
    ...
    description: 'AI-driven supply chain optimization and predictive maintenance.',
    ...
    contacts: [
      { name: 'Wei Chen', email: 'w.chen@apaclogistics.example.com', isDefault: true }
    ],
    users: [
      { email: 'w.chen@apaclogistics.example.com', firstName: 'Wei', lastName: 'Chen', title: 'Lead AI Scientist' }
    ],
    reviews: [
      { rating: 4, comment: 'Great AI insights, helped us save 15% on fuel.', reviewerName: 'DHL APAC', date: '2024-02-15' }
    ]
  },
  {
    id: '5',
    ...
    description: 'Strategic management consulting with a focus on digital change management.',
    ...
    contacts: [
      { name: 'Hans Muller', email: 'h.muller@eurostrat.example.com', isDefault: true }
    ],
    users: [
      { email: 'h.muller@eurostrat.example.com', firstName: 'Hans', lastName: 'Muller', title: 'Senior Partner' }
    ],
    reviews: []
  }
];
...
export const MOCK_OPPORTUNITIES: Opportunity[] = [
  ...
  },
  {
    ...
    partnerId: '2',
    deadline: '2024-06-01',
    description: 'Urgent need for 3 Senior IoT Engineers for a 6-month automotive project.',
    fullDescription: 'We are currently 2 months into a digital twin project for a German automotive manufacturer. Due to scope expansion, we urgently require 3 Senior IoT Engineers to join the team. \n\nTech Stack:\n- Azure IoT Hub\n- C# / .NET Core on Edge devices\n- MQTT protocol\n\nThis is a staff augmentation arrangement. Resources can work remotely within +/- 2 hours of CET, but monthly site visits to Munich may be required.',
