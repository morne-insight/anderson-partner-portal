...
import { ReviewComponent } from '@/components/app/Reviews/ReviewComponent'
  ...
  if (!partner) {
    return (
      <div className="p-12 text-center">
        ...
        <Link className="mt-4 block text-red-600 hover:underline" to="/partners">
          Return to Directory
        </Link>
      </div>
    )
          ...
          <div className="flex flex-col items-start justify-between gap-8 md:flex-row">
            <div>
              <div className="mb-4 flex items-center gap-3">
                <h1 className="font-serif text-5xl text-black leading-tight">{partner.name}</h1>
                {/* {partner.verified && (
            ...
            <div className="flex w-full flex-col gap-4 sm:flex-row md:w-auto">
              <ConnectRequestDialog partnerId={partner.id as string} partnerName={partner.name}>
                <button
