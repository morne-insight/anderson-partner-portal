...
import { Calendar, MapPin, ArrowRight, Loader2, Building, ChevronDown, ChevronUp } from "lucide-react";
        ...
        <div className="space-y-8 animate-fade-in text-left">
            ...
            <div className="flex gap-8 border-b border-gray-200">
                <button
                    ...
                    className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all ${activeTab === 'all' ? 'border-b-2 border-black text-black' : 'text-gray-400 hover:text-gray-600 border-transparent hover:border-gray-200'
                        }`}
                >
                    Opportunities
                </button>
                <button
                    ...
                    className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all ${activeTab === 'me' ? 'border-b-2 border-black text-black' : 'text-gray-400 hover:text-gray-600 border-transparent hover:border-gray-200'
                        }`}
                >
                    My Opportunities
                </button>
                <button
                    ...
                    className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all ${activeTab === 'saved' ? 'border-b-2 border-black text-black' : 'text-gray-400 hover:text-gray-600 border-transparent hover:border-gray-200'
                        }`}
                >
                    Saved Opportunities
                </button>
            ...
            <div className="grid grid-cols-1 gap-8">
                {isLoading ? (
                    ...
                    currentOpportunities?.map((opp: any) => (
                        ...
                        >
                            <div className="bg-white border border-gray-200 hover:border-red-600 transition-all duration-300 group p-0 overflow-hidden shadow-sm text-left">
                                <div className="p-8 md:p-10">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                                        <div className="flex items-center gap-4">
                                            <span
                                                className={`px-3 py-1 text-[10px] font-bold uppercase tracking-widest border ${opp.opportunityTypeString === "Tender"
                                        ...
                                        <div>
                                            {activeTab === 'me' ? (
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    >
                                                        Edit Opportunity <ArrowRight className="ml-2 w-4 h-4" />
                                                    </Link>
                                                    <CollapsibleTrigger asChild>
                                                        <Button
                                                            variant="outline"
                                                            size="sm"
                                                            className="text-xs font-bold uppercase tracking-[0.15em] border-gray-300 hover:border-gray-400"
                                                        >
                                                            {expandedOpportunities.has(opp.id) ? (
                                                                <>
                                                                    Hide Messages <ChevronUp className="ml-2 w-4 h-4" />
                                                                </>
                                                            ) : (
                                                                <>
                                                                    Show Messages <ChevronDown className="ml-2 w-4 h-4" />
                                                                </>
                                                            )}
                                                        </Button>
                                                    </CollapsibleTrigger>
